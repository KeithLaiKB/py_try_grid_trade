...
class OcoManagement:
    ...
    def placeAnOcoOder(dict_myparam):
        ...
        if response.status_code == 200:
            ...
            #
            # 例如
            # E:\mygit_workspace\grid_trade\py_try_grid_trade\py_try_grid_trade_workspace1\order_record\placeorder\y_2021\m_05\d_29
            ...
            #
            ########### mkdir ###########
            str_storePath = root_path + "\\order_record" + "\\placeorder" + "\\" + year_tmp + "\\" + month_tmp + "\\"+ day_tmp
    ...
    def deleteOcoOderListBySymbolAndOrderListId(mySymbol, myOrderListId):
        ...
        if response.status_code == 200:
            ...
            #
            ########### mkdir ###########
            str_storePath = root_path + "\\order_record" + "\\deleteorder" + "\\" + year_tmp + "\\" + month_tmp + "\\" + day_tmp
            MyDealFile.mymkdir(str_storePath)
            #
            ###### write json file #######
            filename = str_storePath + "\\" + str_now_time_tmp + ".json"
