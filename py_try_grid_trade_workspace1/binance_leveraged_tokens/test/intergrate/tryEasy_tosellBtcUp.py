...
if __name__ == '__main__':
    ...
    '''
    #
    initial_expected_profit_rate    = 0.008          # 相较于当前的myprice的 比例
    initial_expected_loss_rate      = 0.008          # 相较于当前的myprice的 比例
    after_expected_profit_rate      = 0.008          # 相较于当前的myprice的 比例
    after_expected_loss_rate        = 0.008          # 相较于当前的myprice的 比例
    #
    step_update_interval            = 0.100        # myprice=now_price 后进行 更新的幅度
    #
